...
function renderDrawer(){
  ...
  foot.innerHTML = `
    ...
    <p style="font-size:10.5px;color:#8592AA;margin-top:9px;line-height:1.5;">Order status stays <b>Pending Verification</b> until admin confirms your ${selectedPay} / bank reference. You'll get the confirmation in your account's <b>Mailbox</b> — no external email needed.</p>
  `;
}
...
function checkout(){
  ...
  orders.unshift({id:orderId, total: cartTotal(), status:'Pending Verification', method: selectedPay, date: new Date().toLocaleDateString()});
